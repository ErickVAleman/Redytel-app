...
export default ({ menuItems, validate }) => (
        ...
        <Col>
            ...
            <Col span={8} style={{ textAlign: "center" }} >
                <Menu mode="horizontal" style={{ lineHeight: "63px" }}>
                    { 
                        validate ? menuItems.map( ({ href, title }, key) => (<Item key={key + 1}><Link href={href} ><a>{ title }</a></Link></Item>)) : <div><Link href="/login" ><a>Login</a></Link> / <Link href="/register" ><a>Registrar</a></Link></div>
                    }    
                </Menu>
            </Col>
        </Col>
